...
>
  ...
  >
        {/* Add your logo here */}
        <img src={cbLogo} alt="CipherNet Logo" style={{ width: "20%", height: "45%" }} />

        <div className="text-3xl md:text-8xl font-bold text-center" style={{ color: "#17e0e7" }}>
          CipherNet Coming Soon.
        </div>
        <div className="font-extralight text-center md:text-2xl" style={{ color: "white" }}>
