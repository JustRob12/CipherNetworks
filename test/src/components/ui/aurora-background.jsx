...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "relative flex flex-col h-[100vh] overflow-y-auto overflow-x-hidden items-center justify-center bg-black text-slate-50 transition-bg",
          className
        )}
        {...props}
      >
        ...
        <div className="z-10 w-full">{children}</div> {/* Ensure children stay on top */}
      </div>
    </main>
  );
};
